    ...
    return (
      <section className="flex flex-col items-center w-full mt-28 mb-28">
        <div className="text-center mb-4 w-full">
          <h1 className="text-3xl md:text-5xl text-center font-bold mb-4 lg:mb-6">Título do Vídeo teste teste teste</h1>
          <p className="text-base text-center font-light md:text-lg lg:mb-4">
